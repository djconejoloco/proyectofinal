...
public class Almacen extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Almacen(JComboBox<Trabajadores> combo1) {
		...
		textField_2.setBounds(10, 370, 169, 20);
		...
		btnGuartarEnArchivo.setBounds(423, 300, 197, 23);
		...
		table.setBounds(325, 18, 360, 256);
